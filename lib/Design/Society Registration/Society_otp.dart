...
class SocietyOtp extends StatefulWidget {
  const SocietyOtp({super.key});

  @override
  State<SocietyOtp> createState() => _SocietyOtpState();
}

class _SocietyOtpState extends State<SocietyOtp> {
  ...
  Widget build(BuildContext context) {
    return  SafeArea(
          child: Center(
            child: Column(
              children: [
                Image.asset('assets/sec_otp.png', width: 300, height: 150),
                SizedBox(height: 2),
                Text(
                  "Please Enter OTP",
